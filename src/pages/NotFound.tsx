    ...
    <div className="relative w-full min-h-screen pt-32 bg-[#050505] overflow-x-hidden flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center relative z-10 px-6">
        <div className="text-center max-w-2xl mx-auto">
          ...
          >
            <svg viewBox="0 0 300 120" className="w-full h-auto max-w-[600px] mx-auto overflow-visible">
              <defs>
          ...
          >
            ...
            >
              <Link to="/">
                <button className="px-12 py-3 bg-black text-white text-sm font-medium rounded-full hover:bg-gray-900 transition-colors group">

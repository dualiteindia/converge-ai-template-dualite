...
const integrations = [
  {
    id: 'openai',
    name: 'OpenAI',
    description: 'OpenAI\'s groundbreaking models empower Converge AI to deliver natural, human-like conversations, creative assistance.',
    icon: OpenAILogo,
  ...
  },
  {
    id: 'claude',
    name: 'Claude',
    description: 'Claude\'s advanced reasoning and context understanding make Converge AI smarter and more intuitive for deep problem-solving.',
    icon: ClaudeLogo,
    color: 'hover:border-[#D97757]/50 hover:shadow-[0_0_30px_rgba(217,119,87,0.1)]',
    iconColor: 'text-white'
  },
  {
    id: 'gemini',
    name: 'Google Gemini',
    description: 'Gemini\'s innovative AI features enrich Converge AI with cutting-edge tools for creativity, data analysis, and seamless collaboration.',
    icon: GeminiLogo,
  ...
  },
  {
    id: 'cohere',
    name: 'Cohere',
    description: 'Cohere\'s robust natural language processing powers Converge AI with exceptional text understanding, generation, and analysis capabilities.',
    icon: CohereLogo,
    color: 'hover:border-[#39594D]/50 hover:shadow-[0_0_30px_rgba(57,89,77,0.1)]',
    iconColor: 'text-white'
  },
  {
    id: 'grok',
    name: 'Grok',
    description: 'Grok brings rapid responsiveness and insightful AI solutions to Converge AI, enhancing productivity and delivering dynamic user experiences.',
    icon: GrokLogo,
  ...
  },
  {
    id: 'perplexity',
    name: 'Perplexity',
    description: 'Perplexity\'s focus on precision and exploration enhances Converge AI\'s search and discovery features, delivering accurate, in-depth insights.',
    icon: PerplexityLogo,
    color: 'hover:border-[#22B8CD]/50 hover:shadow-[0_0_30px_rgba(34,184,205,0.1)]',
    iconColor: 'text-white'
  },
  {
    id: 'llama',
    name: 'Llama',
    description: 'Meta\'s LLaMA represents a cutting-edge effort in generative AI, offering advanced capabilities for natural language understanding.',
    icon: LlamaLogo,
    color: 'hover:border-[#0668E1]/50 hover:shadow-[0_0_30px_rgba(6,104,225,0.1)]',
    iconColor: 'text-white'
  },
  {
    id: 'deepseek',
    name: 'DeepSeek',
    description: 'DeepSeek\'s new R1 model is a breakthrough in AI-driven search, combining semantic understanding with advanced contextual analysis.',
    icon: DeepSeekLogo,
    color: 'hover:border-[#4D6BFE]/50 hover:shadow-[0_0_30px_rgba(77,107,254,0.1)]',
    iconColor: 'text-white'
  },
  {
    id: 'deepgram',
    name: 'Deepgram',
    description: 'Deepgram TTS (Text-to-Speech) leverages end-to-end deep learning to deliver remarkably natural, real-time voice synthesis.',
    icon: DeepgramLogo,
    color: 'hover:border-white/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]',
    iconColor: 'text-white'
  },
  {
    id: 'elevenlabs',
    name: 'Eleven Labs',
    description: 'Eleven Labs\' TTS stands out for its hyper-realistic voice generation, supporting multiple voices and languages, making it a popular choice.',
    icon: ElevenLabsLogo,
    color: 'hover:border-white/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]',
    iconColor: 'text-white'
  },
  {
    id: 'runway',
    name: 'Runway',
    description: 'Runway is an applied research company building the next era of art, entertainment and human creativity.',
    icon: RunwayLogo,
    color: 'hover:border-white/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]',
    iconColor: 'text-white'
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-32">
          <div className="flex flex-col items-start">
            ...
            >
              ...
              >
                <button className="px-8 py-3 bg-black text-white text-sm font-medium rounded-full hover:bg-gray-900 transition-colors group">

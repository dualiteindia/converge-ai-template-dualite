...
const values = [
  {
    title: "Our Mission",
    description: "To democratize AI automation, empowering teams to build and deploy intelligent workflows without writing a single line of code.",
    shape: "circle"
  },
  {
    title: "Executional Excellence",
    description: "We fuse cutting-edge LLM intelligence, rock-solid security, and seamless integrations to ensure flawless performance at any scale.",
    shape: "triangle"
  },
  {
    title: "Our Vision",
    description: "To pioneer a future where AI agents power every business process—making operations smarter, faster, and truly autonomous.",
    shape: "square"
  }
];
...
const timeline = [
  ...
  {
    year: "2024",
    description: "Opened a closed beta, added 50 + app integrations, launched our no-code workflow builder, and honed the user experience.",
    image: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop",
    align: "left"
  },
  {
    year: "2025",
    description: "Official public launch with 200 + customers onboarded, $3 M+ in cost savings realized, and enterprise-grade features rolled out.",
        ...
        {type === 'triangle' && (
          <div className="relative w-20 h-20 flex items-center justify-center">
             <svg width="80" height="80" viewBox="0 0 100 100" fill="none">
                <path d="M50 15 L85 80 L15 80 Z" stroke="url(#tri-gradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="drop-shadow-[0_0_15px_rgba(59,130,246,0.4)]" />
                <defs>
                   <linearGradient id="tri-gradient" x1="15" y1="80" x2="50" y2="15">
    ...
    <div className="w-full py-20 overflow-hidden">
      ...
      <div className="relative w-full">
        ...
        <div className="flex gap-8 animate-scroll pl-[50vw]">
          {[...cultureImages, ...cultureImages, ...cultureImages].map((src, i) => (
            <div 
              key={i} 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-5 flex flex-col items-start">
          ...
          <div className="space-y-4 mb-10">
            <h3 className="text-lg font-medium text-white">Got any Questions?</h3>
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          {jobs.map((job, i) => (
            ...
            >
              <div>
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-blue-400 transition-colors">{job.title}</h3>
    ...
    <div className="relative w-full min-h-screen pt-32 px-6 bg-[#050505] overflow-x-hidden">
            ...
            >
              ...
              <div className="w-full md:w-1/2 pl-16 md:pl-0">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden border border-white/10">
                  <img src={item.image} alt={item.year} className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
              </div>

              {/* Content Side */}
              <div className="w-full md:w-1/2 pl-16 md:pl-0 text-left">
                <div className="text-3xl md:text-4xl font-bold text-white mb-4">{item.year}</div>
      ...
      <div className="max-w-7xl mx-auto mb-32 text-center px-4 md:px-0">
        ...
        <div className="flex flex-wrap justify-center gap-12 md:gap-20">
           ...
           <div className="w-full hidden md:block" /> {/* Line break for visual alignment if needed */}
           <InvestorLogo name="Logoipsum" icon={Layers} />

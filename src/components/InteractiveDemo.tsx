    ...
    <div className={cn(
      ...
      {isAi ? (
        <div className="relative w-8 h-8">
           <Sparkles className="w-6 h-6 text-blue-500 absolute top-1 left-1" fill="currentColor" fillOpacity={0.2} />
...
export const InteractiveDemo = () => {
  ...
  return (
    <section ref={containerRef} className="relative z-20 w-full py-24 px-4 flex justify-center items-center overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 w-72 bg-[#050505] border-r border-white/5 flex flex-col p-6 hidden md:flex">
          ...
          <button className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-white/10 bg-white/[0.03] hover:bg-white/[0.06] text-gray-200 text-sm font-medium transition-all mb-8 shadow-sm group">
            <Sparkles size={16} className="text-blue-500 group-hover:text-blue-400 transition-colors" />
            New Chat
          </button>
               ...
               <div className="relative bg-[#080808] rounded-2xl p-4 flex flex-col gap-4">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center gap-2">
                      <button className="px-3 py-1.5 rounded-lg bg-white/10 text-xs font-medium text-white border border-white/5">
                        Chat
                      </button>
                      <button className="px-3 py-1.5 rounded-lg hover:bg-white/5 text-xs font-medium text-gray-500 hover:text-gray-300 transition-colors">
                        Launch Workflow
                      </button>
                      <button className="px-3 py-1.5 rounded-lg hover:bg-white/5 text-xs font-medium text-gray-500 hover:text-gray-300 transition-colors">
                        Data Analysis
                    ...
                    <button className="flex items-center gap-2 px-4 py-1.5 rounded-lg bg-[#1A1A1A] border border-orange-500/30 text-white text-xs font-medium hover:bg-orange-500/10 hover:border-orange-500/60 transition-all group/btn">
                      <Sparkles size={14} className="text-orange-500 group-hover/btn:scale-110 transition-transform" />
                      Send
                    </button>
                  </div>

    ...
    <div className="relative z-10 w-[280px] flex flex-col gap-4">
      ...
      <div className="relative group">
        ...
        <div className="relative bg-black/80 backdrop-blur-sm border border-white/10 rounded-xl p-4 flex items-center justify-center">
          <span className="text-white font-medium tracking-wide">AI Analyst</span>
        </div>
      </div>
  ...
  <div className="relative w-full h-full bg-[#050505] overflow-hidden rounded-2xl border border-white/5 flex items-center justify-center">
    ...
    <div className="relative z-10 w-[300px] space-y-4">
        ...
        <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-xs text-gray-500 bg-white/5 px-2 py-1 rounded">Last 7 days</div>
        </div>
        ...
        <div className="flex items-end justify-between h-[140px] gap-2">
            {[40, 70, 45, 90, 65, 85, 50].map((h, i) => (
                <div key={i} className="w-full bg-white/5 rounded-t-sm relative group overflow-hidden" style={{ height: `${h}%` }}>
                    ...
                    {i === 3 && <div className="absolute top-0 left-0 right-0 h-[2px] bg-orange-500 shadow-[0_0_10px_#F97316]" />}
                </div>
            ))}
        </div>
...
const Card: React.FC<CardProps> = ({ i, title, description, features, Visual, progress, range, targetScale }) => {
  ...
  const StarBullet = () => (
    <div className="relative w-5 h-5 flex-shrink-0 mt-0.5">
        <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
            ...
            <path d="M12 2L14.4 9.6L22 12L14.4 14.4L12 22L9.6 14.4L2 12L9.6 9.6L12 2Z" fill={`url(#star-grad-${i})`} />
        </svg>
    </div>
  );
      ...
      >
        ...
        <div className={cn("flex flex-col md:flex-row w-full h-full gap-8 md:gap-12", i % 2 === 0 ? "" : "md:flex-row-reverse")}>
            ...
            <div className="flex-1 flex flex-col justify-center">
                ...
                <button className="mt-10 w-fit flex items-center gap-2 text-white font-medium border-b border-orange-500 pb-1 hover:text-orange-500 transition-colors group">
                    Learn more
...
const projects = [
  {
    ...
    description: "Design complex, multi-step automations with drag-and-drop ease—no coding required.",
    features: [
  ...
  },
  {
    ...
    description: "Chat with your AI agents to run tasks, query data, or generate content—just type what you need.",
    features: [
        "Context-aware Q&A",
  ...
  },
  {
    ...
    description: "Track performance metrics and get actionable insights on your AI workforce in real-time.",
    features: [
    ...
    <section className="py-24 relative z-20">
        ...
        <div className="max-w-7xl mx-auto px-6 mb-12 md:mb-24 text-center">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                Powerful tools designed to help you build, manage, and optimize your AI workforce without writing a single line of code.
            </p>
        </div>
